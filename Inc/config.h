...
мигает все 1раз, после покажет заряд джойстика (градация 0-25%, 25-50%, 50-75%, 75-100%).
  При долгом удержании кнопки home 4s (в доп настройках (кн. select)) поазывает заряд акб приемника-----не реализованно, нет обратной связи
